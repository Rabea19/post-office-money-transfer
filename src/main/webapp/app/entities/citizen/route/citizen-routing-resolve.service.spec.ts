...
import citizenResolve from './citizen-routing-resolve.service';

describe('Citizen routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: CitizenService;
  let resultCitizen: ICitizen | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ICitizen returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        citizenResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCitizen).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICitizen>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
