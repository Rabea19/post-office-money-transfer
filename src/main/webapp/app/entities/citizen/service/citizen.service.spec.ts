...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../citizen.test-samples';

import { CitizenService } from './citizen.service';

const requireRestSample: ICitizen = {
...
describe('Citizen Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Citizen', () => {
      const citizen = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(citizen).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Citizen', () => {
      const citizen = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(citizen).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should handle exceptions for searching a Citizen', () => {
    ...
    describe('addCitizenToCollectionIfMissing', () => {
      it('should add a Citizen to an empty array', () => {
        const citizen: ICitizen = sampleWithRequiredData;
      ...
      it("should add a Citizen to an array that doesn't contain it", () => {
        const citizen: ICitizen = sampleWithRequiredData;
        const citizenCollection: ICitizen[] = [sampleWithPartialData];
        expectedResult = service.addCitizenToCollectionIfMissing(citizenCollection, citizen);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(citizen);
      });
      ...
      it('should add only unique Citizen to an array', () => {
        const citizenArray: ICitizen[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const citizenCollection: ICitizen[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const citizen: ICitizen = sampleWithRequiredData;
        const citizen2: ICitizen = sampleWithPartialData;
    ...
    describe('compareCitizen', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareCitizen(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareCitizen(entity1, entity2);
        const compareResult2 = service.compareCitizen(entity2, entity1);
